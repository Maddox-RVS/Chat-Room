...
class ClientHandler(Thread):
    def __init__(self, clientSocket: socket.socket, clientAddress, serverClients: list['ClientHandler'], username: str):
        super().__init__()
    ...
    def run(self):
        try:
            ...
            if not self.disconnected: printError(f'Error handling client {self.clientAddress}!')
        finally:
